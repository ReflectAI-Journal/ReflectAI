    ...
    const createCheckout = async () => {
      ...
      try {
        ...
        if (!response.ok) {
          ...
          if (errorData.error === 'PAYMENT_SYSTEM_UNAVAILABLE') {
            // Fallback to subscription page if payment system is unavailable
            setLocation('/subscription?error=payment_unavailable');
            return;
          }
